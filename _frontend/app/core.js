...
function translate(id) {
	var abbr = moment_locale._abbr;
	if (TRANSLATE[abbr] !== undefined) {
		return TRANSLATE[abbr].translate(id);
	}
	return id;
}

function get_public_holidays() {
	if (COUNTRIES_REDEFINE[user_data.country] !== undefined) {
		return COUNTRIES_REDEFINE[user_data.country].public_holidays;
	}
	return get_country(user_data.country).public_holidays;
}
