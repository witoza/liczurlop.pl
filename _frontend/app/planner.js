...
function set_locale_first(locale) {
	console.log("setting first locale", locale);
	moment_locale = moment.localeData(locale);
	
	if (is_empty(window.location.search)) {
...
$(document).ready(function() {
	...
	set_locale_first(tl);
	moment_locale_en = moment.localeData('en_GB');
